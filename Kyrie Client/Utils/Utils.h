...
static const char* const KeyNames[] = {
	...
	class Utils {
	public:
	static uintptr_t getGameAddress();
	static uintptr_t findSignature(std::string_view sig);
	static uintptr_t** getVtableFromSig(std::string_view sig);
	...
	inline static Ret CallVFunc2(int index, void* _this, Args... args) {
